...
//            http://docs.oracle.com/javaee/6/tutorial/doc/glraq.html
            ...
            if (chunkSize < 1) {
                ...
                try (InputStream is = filePart.getInputStream();
                   ...
                   List<CityProcessor.FailedCity> failedCity = cityProcessor.process(is2, chunkSize);
                    List<UserProcessor.FailedEmails> failedUser = userProcessor.process(is, chunkSize);
                    log.info("Failed users: " + failedUser);
                    log.info("Failed citys: " + failedCity);
                    final WebContext webContext =
                            new WebContext(req, resp, req.getServletContext(), req.getLocale(),
                                    ImmutableMap.of("users", failedUser));
