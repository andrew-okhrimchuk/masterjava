...
import static ru.javaops.masterjava.persist.ProjectTestData.FIST5_projects;
import static ru.javaops.masterjava.persist.ProjectTestData.project1;
...
public class ProjectDaoTest extends AbstractDaoTest<ProjectDao> {
    ...
    public void getWithLimit() {
        ...
        Assert.assertEquals(FIST5_projects, projects);
    }

    @Test
    public void insertBatch() throws Exception {
        dao.clean();
        dao.insertBatch(FIST5_projects, 5);
